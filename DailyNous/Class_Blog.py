...
class Blog():
    def __init__(self):
        ...
        self.seed_url = "https://dailynous.com/2021/07/" #customize
        self.soup = ""
    ...
    def get_article_urls(self): #find urls in soup
        ...
        all_urls = self.soup.find_all("h3", class_="article__title entry-title", limit=30) #customize
...
class Post():
    ...
    def get_title(self):
        ...
        item = self.soup.find("h1", class_="article__title entry-title") #customize
        if item:
    ...
    def get_content(self):
        ...
        item = self.soup.find("section") #customize
